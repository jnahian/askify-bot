      ...
      <Container size="xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-[var(--text-secondary)]">
            From critical decisions to casual team building — Askify adapts to
            your needs
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {useCases.map((useCase, index) => (
            <Card key={index} hover noPadding>
              <div
                className={`p-6 bg-gradient-to-br ${useCase.bgColor} border-b border-[var(--border)]`}
              >
        ...
        <div className="text-center mt-12">
          <p className="text-[var(--text-secondary)] mb-4">
            And many more scenarios — anonymous voting, scheduled polls,
